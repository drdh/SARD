...
from design_opt.envs.derl_envs.modules.agent import create_agent_xml
...
class MultiUnimalNodeCentricObservation(gym.ObservationWrapper):
    ...
    def observation(self, obs):
        ...
        # obs["env_name"] = self.env.unwrapped.unimal_id
        return obs
...
class MultiUnimalNodeCentricAction(gym.ActionWrapper):
    ...
    def _update_action_space(self):
        ...
        num_pads = self.max_limbs - num_joints
...
class ToTransform2ActWrapper(gym.Wrapper):
    def __int__(self, env):
        super(ToTransform2ActWrapper, self).__int__()
