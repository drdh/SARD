...
from design_opt.envs.derl_envs.yacs import CfgNode as CN
...
_C.ENV.CTRL_COST_WEIGHT = 0.0 # 1e-3
...
_C.MODEL.MAX_JOINTS = 20

# Max number of limbs across all the envs
_C.MODEL.MAX_LIMBS = 20
...
_C.UNIMAL_TEMPLATE = "design_opt/envs/derl_envs/assets/unimal.xml"
